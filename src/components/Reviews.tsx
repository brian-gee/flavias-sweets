...
export default function Reviews() {
  return (
    <div className="pb-20">
      <h1 className="p-2 text-center text-4xl font-bold text-slate-900 xl:text-5xl">
        What our customers have to say
      </h1>
      <div className="mx-auto grid max-w-7xl grid-cols-1 justify-items-center gap-10 p-10 sm:grid-cols-3">
        {reviews.map((review) => (
          <div
            key={review.name}
